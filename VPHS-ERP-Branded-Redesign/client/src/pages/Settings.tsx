          ...
          <form onSubmit={handleSaveCompany} className="space-y-4 text-xs">
            <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-[11px] text-slate-500 mt-1">Official VPHS branding used across the portal, payslips and ID cards.</p>
              </div>
              <div className="bg-[#070e20] rounded-xl border border-amber-500/40 px-4 py-2 shadow-sm">
                <img
                  src="/vphs_logo.png"
                  alt="VPHS Services Pvt. Ltd. company logo"
